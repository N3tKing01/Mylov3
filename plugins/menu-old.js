...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/q5jlr6.jpeg` },
                caption: dec,
                contextInfo: {
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(
            from,
            https://files.catbox.moe/q5jlr6.jpeg` },
                caption: dec,
                contextInfo: {
                    mentionedJid: [m.sender],
                    forwardingScore: 999,
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/16nuy2.jpeg` },
                caption: dec,
                contextInfo: {
                    mentionedJid: [m.sender],
                    forwardingScore: 999,
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/09fwjb.jpg` },
                caption: dec,
                contextInfo: {
                    mentionedJid: [m.sender],
                    forwardingScore: 999,
