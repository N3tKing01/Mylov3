...
const sessdata = config.SESSION_ID.replace("BOYKA-XD~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ 𝙷𝙴𝙻𝙻𝙾 𝙱𝙾𝚈𝙺𝙰 𝚇𝙳 𝙻𝙴𝙶𝙴𝙽𝙳𝚂! ✨*

╭─〔 *💻 𝑩𝑶𝒀𝑲𝑨 𝑿𝑫 𝑩𝑶𝒀𝑲𝑨* 〕  
├─▸ *𝕤𝕚𝕞𝕡𝕝𝕚𝕔𝕚𝕥𝕪. 𝕤𝕡𝕖𝕖𝕕. 𝕡𝕠𝕨𝕖𝕣𝕖𝕕 . 𝕓𝕪 ᴛᴇʟᴋɪɴɢ |*  
╰─➤ *𝙃𝙚𝙧𝙚 𝙖𝙧𝙚 𝙣𝙚𝙬 𝙬𝙝𝙖𝙩𝙨𝙖𝙥𝙥 𝙨𝙞𝙙𝙚𝙠𝙞𝙘𝙠!*

❤️ 𝙏𝙝𝙖𝙣𝙠 𝙮𝙤𝙪 𝙛𝙤𝙧 𝙘𝙝𝙤𝙤𝙨𝙞𝙣𝙜 𝘽𝙊𝙔𝙆𝘼 𝙓𝘿v𝟓!

╭──〔 🔗 𝙦𝙪𝙞𝙘𝙠 𝙡𝙞𝙣𝙠𝙨 〕  
├─ 📢 𝙅𝙤𝙞𝙣 𝙘𝙝𝙖𝙣𝙣𝙚𝙡:  
│   Click [𝙃𝙚𝙧𝙚](https://whatsapp.com/channel/0029VaraMtfFcowAKRdDdp1T) to join!  
├─ ⭐ *𝙂𝙞𝙫𝙚 𝙪𝙨 𝙨𝙩𝙖𝙧 𝙖𝙣𝙙 𝙛𝙤𝙧𝙠:*  
│   𝙎𝙩𝙖𝙧 𝙪𝙨 [𝙃𝙚𝙧𝙚](https://github.com/Joshuamambo1/BOYKA-XD)!  
╰─🛠️ *Prefix:* \`${prefix}\`

> _© 𝙼𝙰𝙳𝙴 𝙱𝚈 𝚃𝙴𝙻𝙺𝙸𝙽𝙶 _`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/mpx2sv.jpeg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('263716985350', '263777756184', '263738403205');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("263716985350")){
  if(isReact) return
  m.react("🤍")
   }
  //==========public react============//
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send(" 𝘽𝙊𝙔𝙆𝘼 𝙓𝘿v5 𝑰𝑺 𝑺𝑻𝑨𝑹𝑻𝑬𝑫 ✅");
  });
